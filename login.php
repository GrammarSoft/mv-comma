...
<head>
	...
	<title>Kommaforslag Login</title>
...
<div id="margin_container">
	...
	<div id="pitch">
		...
		<a href="https://kommaer.dk/">For privatlicenser, kontakt GrammarSoft på <span>kommaer.dk</span></a>
	</div>
</div>
...
$(function() {
	...
	if (mv_session_id && !mv_has_access && window.location.href.indexOf('SessionID=') !== -1) {
		alert('Din brugerkonto har ikke adgang til Kommaforslag - kontakt http://mv-nordic.com/');
		return;
	}
